...
/// Works alongside the HTTP lobby server to enable P2P connections without port forwarding.
/// </summary>
public sealed class NatPunchServer : IDisposable, INatPunchListener
{
    ...
    /// Called when a host registers their lobby with the HTTP lobby server.
    /// </summary>
